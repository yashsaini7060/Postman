...
SMTP_SERVER = ("mail.usyd.edu.au", 25)
"""
The domain name and default SMTP port (25) used to connect to the USYD mail server to send 
emails via SMTP.
"""
...
def get_to_users() -> tuple[EmailUser, ...]:
    ...
    while not input_finished:
        ...
        input_users_confirmation = input("Would you like to input any more recipients? [y/N] "
                                         ).lower()
